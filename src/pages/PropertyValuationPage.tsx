...
export const PropertyValuationPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <section className="py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transform transition-all duration-1000 ${
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 bg-black rounded-3xl mb-6 shadow-lg transform hover:scale-110 transition-transform duration-300">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed mb-8">
              Leading property consultants in India with <span className="text-black font-bold">50+ professionals</span> and 
              <span className="text-black font-bold"> 12+ years of expertise</span> delivering accurate, transparent, 
              and reliable valuation solutions across multiple business verticals.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="group px-8 py-4 bg-black text-white rounded-2xl font-bold text-lg hover:bg-gray-800 transition-all duration-500 transform hover:scale-105 shadow-lg">
                <span className="flex items-center space-x-2">
                  <Phone className="w-5 h-5" />
                  <span>Call +91 9788752611</span>
                </span>
              </button>
              <button className="group px-8 py-4 border-2 border-black text-black rounded-2xl font-bold text-lg hover:bg-black hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg">
                <span className="flex items-center space-x-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-8">
              {coreServices.map((service, index) => (
                ...
                >
                  <div className={`flex-shrink-0 w-16 h-16 bg-black rounded-2xl flex items-center justify-center shadow-xl transform hover:scale-110 hover:rotate-12 transition-all duration-300 ${
                    activeService === index ? 'animate-bounce' : ''
                  }`}>
                    <service.icon className="w-8 h-8 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-black mb-3 transition-colors cursor-pointer">
                      {service.title}
                    </h3>
            ...
            <div className={`transform transition-all duration-1000 delay-300 ${
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-black relative overflow-hidden sticky top-24">
                  ...
                  <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="flex justify-between text-sm text-gray-600 mt-2">
                        <span>500 sq ft</span>
                        <span className="font-bold text-xl text-black">{area.toLocaleString()} sq ft</span>
                    ...
                    <button className="w-full bg-black text-white py-4 rounded-2xl font-bold text-lg hover:bg-gray-800 transition-all duration-500 transform hover:scale-105 shadow-lg relative overflow-hidden group">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 mb-16">
            {assetClasses.map((asset, idx) => (
              <div key={idx} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-gray-200 hover:border-black text-center group">
                <asset.icon className="w-12 h-12 text-black mx-auto mb-4 group-hover:scale-110 transition-transform" />
                <h4 className="font-bold text-black transition-colors text-sm sm:text-base">
                  {asset.name}
                </h4>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {capabilities.map((capability, idx) => (
              <div key={idx} className="bg-white rounded-3xl p-8 shadow-lg border border-gray-200 hover:border-black hover:shadow-xl transition-all duration-500 transform hover:scale-105 relative overflow-hidden group">
                
                  <div className="w-16 h-16 bg-black rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
                    <capability.icon className="w-8 h-8 text-white" />
                  </div>
                  
                  <h3 className="text-2xl font-bold text-center text-black mb-6 transition-colors">
                    {capability.title}
                  </h3>
                  ...
                  <ul className="space-y-3">
                    {capability.items.map((item, itemIdx) => (
                      <li key={itemIdx} className="flex items-center space-x-3 group/item">
                        ...
                        <span className="text-gray-700 group-hover/item:text-black transition-colors font-medium">{item}</span>
                      </li>
                    ))}
                  </ul>
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 mb-16">
            {clientTypes.map((client, idx) => (
              <div key={idx} className="text-center group">
                <div className="w-20 h-20 bg-black rounded-3xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
                  <client.icon className="w-10 h-10 text-white" />
                </div>
                <h4 className="font-bold text-black mb-2 transition-colors">
                  {client.type}
                </h4>
                <p className="text-2xl font-bold text-black">{client.count}</p>
      ...
      <section className="py-16 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-white rounded-3xl p-8 shadow-2xl border border-blue-200 transform transition-all duration-1000 delay-700 ${
            ...
            <h3 className="text-3xl sm:text-4xl font-bold text-center text-black mb-12">
              Certifications & Professional Credentials
            </h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {certifications.map((cert, idx) => (
                <div key={idx} className="text-center group p-6 rounded-2xl hover:bg-gray-50 transition-all duration-300">
                  <div className="w-16 h-16 bg-black rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
                    <cert.icon className="w-8 h-8 text-white" />
                  </div>
                  <h4 className="font-bold text-black mb-2 transition-colors">
                    {cert.name}
                  </h4>
                  <p className="text-sm text-gray-600 font-mono bg-white border border-gray-200 px-3 py-1 rounded-lg">
                    {cert.id}
                  </p>
                </div>
              ))}
      ...
      <section className="py-16 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-black rounded-3xl p-8 text-white shadow-lg transform transition-all duration-1000 delay-800 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
              {projectServices.map((service, idx) => (
                <div key={idx} className="text-center p-4 bg-white rounded-2xl hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 border border-gray-200">
                  <div className="w-12 h-12 bg-black rounded-xl flex items-center justify-center mx-auto mb-3">
                    <Wrench className="w-6 h-6 text-white" />
                  </div>
                  <p className="font-semibold text-sm text-black">{service}</p>
                </div>
              ))}
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <Target className="w-12 h-12 mx-auto mb-3 text-black" />
                  <h5 className="font-bold mb-2">Strategic Advice</h5>
                  <p className="text-sm text-gray-700">Project goals and business strategy consultation</p>
                </div>
                <div className="text-center">
                  <TrendingUp className="w-12 h-12 mx-auto mb-3 text-black" />
                  <h5 className="font-bold mb-2">Capital Optimization</h5>
                  <p className="text-sm text-gray-700">Maximize ROI from capital expenditure decisions</p>
                </div>
                <div className="text-center">
                  <BarChart3 className="w-12 h-12 mx-auto mb-3 text-black" />
                  <h5 className="font-bold mb-2">Data-Driven Analytics</h5>
                  <p className="text-sm text-gray-700">Predictive analytics for strategic decision-making</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Corporate Clients */}
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-black">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={idx} className="border-l-4 border-gray-300 pl-6">
                    <h4 className="font-bold text-lg text-gray-800 mb-3">{cityGroup.city}</h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {cityGroup.clients.map((client, clientIdx) => (
                        <div key={clientIdx} className="text-sm text-gray-600 py-2 px-3 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors">
                          {client}
                        </div>
                      ))}
                    </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-black">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-center space-x-3 p-3 bg-gray-50 border border-gray-200 rounded-xl hover:bg-gray-100 transition-all duration-300 group">
                    <div className="w-8 h-8 bg-gray-700 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                      <bank.icon className="w-5 h-5 text-gray-100" />
                    </div>
                    <span className="text-gray-600 font-medium group-hover:text-gray-800 transition-colors text-sm sm:text-base">
                      {bank.name}
                    </span>
                  </div>
                ))}
      ...
      <section className="py-16 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-black rounded-3xl p-8 text-white shadow-lg text-center transform transition-all duration-1000 delay-1000 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
            <h3 className="text-3xl sm:text-4xl font-bold mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-white text-black px-8 py-4 rounded-2xl font-bold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center space-x-2">
                <Phone className="w-5 h-5" />
                <span>Call +91 9788752611</span>
              </button>
              <button className="border-2 border-white text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105 flex items-center space-x-2">
                <Mail className="w-5 h-5" />
