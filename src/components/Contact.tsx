    ...
    <section id="contact" className="py-20 bg-white relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className={`text-center mb-8 sm:mb-12 lg:mb-16 transform transition-all duration-1000 ${
         ...
         <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 sm:mb-6 px-4 sm:px-0">
            Let's Start Your
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed px-4 sm:px-0">
           Ready to get started? Contact us today for a <span className="text-black font-bold">free consultation</span> 
           or to learn more about our <span className="text-black font-bold">professional services</span>.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="space-y-8">
            <div className={`transform transition-all duration-1000 delay-200 ${
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-black mb-6 sm:mb-8 px-4 lg:px-0">
                Contact Information
              </h3>
              ...
              <div className="space-y-4 sm:space-y-6 px-4 lg:px-0">
                {contactInfo.map((contact, idx) => (
                  <div 
                    key={idx}
                    className={`flex items-start space-x-3 sm:space-x-4 p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-gray-200 hover:border-black relative overflow-hidden ${
                      activeContact === idx ? 'ring-4 ring-gray-200' : ''
                    }`}
                  >
                    <div className="relative z-10 flex items-start space-x-3 sm:space-x-4 w-full">
                      <div className={`w-12 h-12 sm:w-16 sm:h-16 bg-black rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0 transform transition-all duration-300 ${
                        activeContact === idx ? 'animate-bounce scale-110' : ''
                      }`}>
                        <contact.icon className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                      </div>
                      <div className="flex-1">
                        <h4 className="font-bold text-black text-base sm:text-lg mb-1 sm:mb-2">{contact.title}</h4>
           ...
           <div className={`bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-black transform transition-all duration-1000 delay-400 mx-4 lg:mx-0 ${
              isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'
            }`}>
             <h4 className="font-bold text-black text-lg sm:text-xl mb-4 sm:mb-6 text-center">Why Choose Us?</h4>
              <div className="space-y-3 sm:space-y-4">
                {quickStats.map((stat, idx) => (
                  <div key={idx} className="flex items-center space-x-3 p-2 sm:p-3 rounded-lg sm:rounded-xl hover:bg-gray-50 transition-colors group">
                   <stat.icon className="w-6 h-6 text-black group-hover:scale-110 transition-transform" />
                   <span className="text-gray-700 font-medium group-hover:text-black transition-colors text-sm sm:text-base">{stat.text}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className={`lg:col-span-2 transform transition-all duration-1000 delay-300 ${
           ...
           <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-4 sm:p-6 lg:p-8 border border-black relative overflow-hidden mx-4 lg:mx-0">
              
              <div className="relative z-10">
               <h3 className="text-2xl sm:text-3xl font-bold text-black mb-6 sm:mb-8 text-center">
                  Send Us a Message
                </h3>
                ...
                {isSubmitted ? (
                  <div className="text-center py-8 sm:py-12">
                   ...
                   <h4 className="text-xl sm:text-2xl font-bold text-black mb-3 sm:mb-4">Message Sent Successfully!</h4>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                        ...
                        <input
                          ...
                          required
                         className="w-full px-3 sm:px-4 py-3 sm:py-4 border-2 border-gray-200 rounded-lg sm:rounded-xl focus:border-black outline-none transition-all duration-300 text-black font-medium text-sm sm:text-base"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows={4}
                       className="w-full px-3 sm:px-4 py-3 sm:py-4 border-2 border-gray-200 rounded-lg sm:rounded-xl focus:border-black outline-none transition-all duration-300 resize-none text-black font-medium text-sm sm:text-base"
                        placeholder="Tell us more about your requirements..."
                      ></textarea>
                    </div>

                    <button
                     className="w-full bg-black text-white py-3 sm:py-4 px-4 sm:px-6 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg hover:bg-gray-800 transition-all duration-500 transform hover:scale-105 shadow-lg flex items-center justify-center space-x-2 relative overflow-hidden group"
                    >
        ...
        <div className={`mt-8 sm:mt-12 lg:mt-16 transform transition-all duration-1000 delay-600 ${
         ...
         <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-3 sm:p-4 overflow-hidden border border-black mx-4 sm:mx-0">
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-lg">
              <div className="mb-4 text-center">
                <div className="flex items-center justify-center space-x-3 mb-2">
                 ...
                 <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-black">Visit Our Office</h4>
                </div>
