      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-12 sm:mb-16 lg:mb-20">
          <div className={`transform transition-all duration-1000 ${
            ...
            <div className="inline-flex items-center space-x-2 px-6 py-3 bg-white border-2 border-black rounded-full text-black font-medium mb-6 shadow-lg">
              <Star className="w-5 h-5" />
              <span>About Our Company</span>
            </div>

            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-4 sm:mb-6 px-4 lg:px-0">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-700 mb-6 sm:mb-8 leading-relaxed px-4 lg:px-0">
              Established in <span className="text-black font-bold">2013</span>, we are Tamil Nadu's leading 
              <span className="text-black font-bold"> gold finance and property valuation company</span> with over 
              <span className="text-black font-bold">12 years of proven expertise</span>. We have successfully served 
              <span className="text-black font-bold">10,000+ satisfied customers</span> across Tamil Nadu, Kerala, and beyond.
            </p>
            
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 mb-6 sm:mb-8 leading-relaxed px-4 lg:px-0">
              As a <span className="text-black font-bold">government-certified valuation company</span> operating since 2013, 
              we provide <span className="text-black font-semibold">instant gold loans</span> and 
              <span className="text-black font-semibold">bank-approved property valuations</span> across Tamil Nadu. 
              Our <span className="text-black font-semibold">certified professionals</span> serve clients in Madurai, 
              ...
              and <span className="text-black font-semibold">same-day service</span>.
            </p>

            {/* Animated Stats */}
            <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6 px-4 lg:px-0">
              {[
                { value: `${Math.min(counters.years, 12)}+`, label: 'Years Since 2013', color: 'text-black', bg: 'bg-white border border-black' },
                { value: `${(counters.clients / 1000).toFixed(0)}K+`, label: 'Happy Clients', color: 'text-black', bg: 'bg-white border border-black' },
                { value: `₹${counters.loans}Cr+`, label: 'Loans Disbursed', color: 'text-black', bg: 'bg-white border border-black' },
                { value: `${(counters.properties / 1000).toFixed(0)}K+`, label: 'Properties Valued', color: 'text-black', bg: 'bg-white border border-black' }
              ].map((stat, idx) => (
          ...
          <div className={`relative transform transition-all duration-1000 delay-300 ${
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 sm:-bottom-6 lg:-bottom-8 -left-2 sm:-left-4 lg:-left-8 bg-white p-3 sm:p-4 lg:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-black transform hover:scale-110 transition-transform duration-300">
                <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-black rounded-xl sm:rounded-2xl flex items-center justify-center">
                    <Award className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-white" />
                  </div>
                  <div>
                    <div className="font-bold text-black text-sm sm:text-base lg:text-lg">Certified Excellence</div>
              ...
              {/* Floating Stats */}
              <div className="absolute -top-3 sm:-top-4 lg:-top-6 -right-2 sm:-right-4 lg:-right-6 bg-white border-2 border-black p-2 sm:p-3 lg:p-4 rounded-xl sm:rounded-2xl shadow-lg text-black">
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-700">Satisfaction</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={`mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 delay-500 ${
          ...
          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-black mb-8 sm:mb-10 lg:mb-12 px-4 sm:px-0">
            Our Core Values
          </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-0">
            {values.map((value, idx) => (
              <div 
                key={idx} 
                className={`text-center group relative overflow-hidden rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 bg-white shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 border border-gray-200 hover:border-black ${
                  activeValue === idx ? 'ring-4 ring-blue-200 scale-105' : ''
                }`}
              >
                <div className="relative z-10">
                  <div className={`w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 bg-black rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-4 sm:mb-6 transform transition-all duration-300 ${
                  ...
                  <h4 className={`text-lg sm:text-xl lg:text-2xl font-bold mb-3 sm:mb-4 transition-colors duration-300 ${
                    activeValue === idx ? 'text-black' : 'text-black'
                  }`}>
                    {value.title}
                  </h4>
        ...
        <div className={`bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg border border-black mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 delay-900 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
        ...
        <div className={`bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg border border-black mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 delay-1000 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          <div className="text-center mb-8">
            <div className="inline-flex items-center space-x-2 px-6 py-3 bg-white border-2 border-black rounded-full text-black font-medium mb-6 shadow-lg">
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-200">
              <h4 className="text-xl sm:text-2xl font-bold text-black mb-4 text-center">
                Fairness & Customer Care
              </h4>
            ...
            {/* Closing Statement */}
            <div className="bg-black rounded-2xl p-6 sm:p-8 text-white text-center shadow-lg">
        ...
        {/* Our Vision Section */}
        <div className={`bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg border border-black mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 delay-1100 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          <div className="text-center mb-8">
            <div className="inline-flex items-center space-x-2 px-6 py-3 bg-white border-2 border-black rounded-full text-black font-medium mb-6 shadow-lg">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-200 text-center">
              <h4 className="text-2xl sm:text-3xl font-bold text-black mb-6">
                Our Vision
              </h4>
        ...
        <div className={`bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg border border-black mb-12 sm:mb-16 lg:mb-20 transform transition-all duration-1000 delay-1200 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          <div className="text-center mb-8">
            <div className="inline-flex items-center space-x-2 px-6 py-3 bg-white border-2 border-black rounded-full text-black font-medium mb-6 shadow-lg">
          ...
          <div className="max-w-5xl mx-auto space-y-6">
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-200">
              <p className="text-base sm:text-lg lg:text-xl text-gray-700 leading-relaxed text-center mb-6">
                At Gokulam, our journey has always been guided by three eternal lights — <span className="text-black font-bold">Credibility</span>, 
                <span className="text-black font-bold"> Reliability</span>, and <span className="text-black font-bold">Trust</span>. 
              ...
              <div className="bg-black rounded-xl p-4 sm:p-6 text-white text-center shadow-lg">
                <p className="text-lg sm:text-xl font-bold">
        ...
        <div className={`bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-lg border border-black transform transition-all duration-1000 delay-700 mx-4 sm:mx-0 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center text-black mb-8 sm:mb-10 lg:mb-12">
              ...
              <div key={idx} className="group text-center">
                <div className="relative mb-4 sm:mb-6">
                  <img 
                    src={member.image}
                    alt={member.name}
                    className="relative w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 rounded-2xl sm:rounded-3xl mx-auto object-cover shadow-lg transform group-hover:scale-110 transition-transform duration-300 border-2 border-black"
                  />
                  <div className="absolute -bottom-1 -right-1 sm:-bottom-2 sm:-right-2 w-6 h-6 sm:w-8 sm:h-8 bg-black rounded-full border-2 sm:border-4 border-white flex items-center justify-center">
                    <div className="w-2 h-2 bg-white rounded-full" />
                  </div>
                </div>
                
                <h4 className="text-lg sm:text-xl lg:text-2xl font-bold text-black mb-1 sm:mb-2 transition-colors">
                  {member.name}
                </h4>
                <p className="text-black font-bold mb-1 sm:mb-2 text-sm sm:text-base">
                  {member.role}
                </p>
