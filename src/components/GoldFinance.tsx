    ...
    <div className="min-h-screen bg-white text-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {[...Array(30)].map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 bg-gray-300 rounded-full opacity-20 animate-pulse"
            style={{
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transform transition-all duration-1000 ${
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gray-800 rounded-3xl mb-6 shadow-2xl transform hover:scale-110 transition-transform duration-300">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6">
              ...
              <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl mt-2 text-gray-800">Unlock Your Gold's Value</span>
            </h1>
            
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 max-w-5xl mx-auto leading-relaxed mb-8">
              Get <span className="text-gray-900 font-bold">instant loans against your gold</span> with competitive rates, 
              <span className="text-gray-900 font-bold"> minimal documentation</span>, and 
              <span className="text-gray-900 font-bold">same-day disbursement</span>. Serving all strata of life across Tamil Nadu.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="group px-8 py-4 bg-gray-800 text-white rounded-2xl font-bold text-lg hover:bg-gray-900 transition-all duration-500 transform hover:scale-105 shadow-2xl">
                <span className="flex items-center space-x-2">
                  <Phone className="w-5 h-5" />
                  <span>Call +91 9788752611</span>
                </span>
              </button>
              <button className="group px-8 py-4 border-2 border-gray-800 text-gray-900 rounded-2xl font-bold text-lg hover:bg-gray-800 hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg">
                <span className="flex items-center space-x-2">
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 mb-16 transform transition-all duration-1000 delay-200 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
            <div className="text-center mb-8">
              <div className="inline-flex items-center space-x-2 px-6 py-3 bg-gray-800 rounded-full text-white font-medium mb-6 shadow-lg">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-8">
                  <div className="text-center p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                    <div className="w-12 h-12 bg-gray-800 rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {features.map((feature, index) => (
                  ...
                  >
                    <div className={`flex-shrink-0 w-16 h-16 bg-gray-800 rounded-2xl flex items-center justify-center shadow-xl transform hover:scale-110 hover:rotate-12 transition-all duration-300`}>
                      <feature.icon className="w-8 h-8 text-white" />
                    </div>
                    <div className="flex-1">
                      <h4 className="text-2xl font-bold text-gray-900 mb-3 hover:text-gray-700 transition-colors cursor-pointer">
                        {feature.title}
                      </h4>
            ...
            <div className={`transform transition-all duration-1000 delay-300 ${
              ...
              <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 relative overflow-hidden sticky top-24">
                  ...
                  <div className="space-y-8">
                    <div>
                      ...
                      <div className="flex justify-between text-sm text-gray-600 mt-2">
                        <span>10g</span>
                        <span className="font-bold text-xl text-gray-900">{goldWeight}g</span>
                        <span>500g</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex justify-between text-sm text-gray-600 mt-2">
                        <span>₹10K</span>
                        <span className="font-bold text-xl text-gray-900">₹{(loanAmount/1000).toFixed(0)}K</span>
                        <span>₹10L</span>
                      </div>
                    </div>
                    ...
                    <button className="w-full bg-gray-800 text-white py-4 rounded-2xl font-bold text-lg hover:bg-gray-900 transition-all duration-500 transform hover:scale-105 shadow-2xl relative overflow-hidden group">
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`bg-gray-800 rounded-3xl p-8 text-white shadow-2xl mb-16 transform transition-all duration-1000 delay-250 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
            <div className="text-center mb-8">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/20 text-center">
                ...
                <p className="text-base sm:text-lg leading-relaxed opacity-90">
                  With <span className="text-white font-bold">Gokulam Gold Loan</span>, you can unlock instant funds for your personal or business needs — whether it's for 
          ...
          <div className={`bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 mb-16 transform transition-all duration-1000 delay-300 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
            <div className="text-center mb-8">
              <div className="inline-flex items-center space-x-2 px-6 py-3 bg-gray-800 rounded-full text-white font-medium mb-6 shadow-lg">
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-200 mb-6">
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-6">
                  <span className="text-gray-900 font-bold">Gokulam Bank</span> offers gold loan to applicants between the age of 
                  <span className="text-gray-900 font-bold"> 18-70 years</span>. While the lender has not disclosed the eligibility criteria of its gold loan applicants in detail, the lender may also consider the 
                  <span className="text-gray-900 font-bold">weight and purity of gold</span> pledged by the applicant while evaluating the gold loan eligibility of its applicants, just like other lenders do.
                </p>
              </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      <span className="text-gray-900 font-semibold">Purity and weight of gold articles</span> also affect the loan amount offered to you. The bank appraises your gold articles and extends loans against the appraised value. Do note that the 
                      <span className="text-gray-900 font-semibold">value of gold articles appraised by the bank might be different from its actual value</span>. This also has an impact on the 
                      <span className="text-gray-900 font-semibold">interest rate offered to you</span>.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-200 mb-8">
                <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-6 text-center">
                  To meet the <span className="text-gray-900 font-bold">immediate financial requirements</span>, gold loan is a 
                  <span className="text-gray-900 font-bold"> preferred choice of individuals</span> for several reasons. 
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 mb-16">
            {benefits.map((benefit, idx) => (
              <div key={idx} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-gray-100 text-center group">
                ...
                <p className="font-medium text-gray-900 group-hover:text-gray-700 transition-colors text-sm sm:text-base">
                  {benefit.text}
                </p>
              </div>
            ))}
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 mb-12 transform transition-all duration-1000 delay-500 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-white rounded-3xl p-8 shadow-2xl border border-gray-200 mb-12 transform transition-all duration-1000 delay-600 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
            <h3 className="text-3xl sm:text-4xl font-bold text-center text-gray-900 mb-8">
              ...
              <table className="w-full border-collapse border border-gray-300 rounded-2xl overflow-hidden shadow-lg">
                ...
                <tbody>
                  {bankGoldLoanRates.map((bank, idx) => (
                    <tr key={idx} className={`${idx % 2 === 0 ? 'bg-gray-50' : 'bg-white'} hover:bg-gray-100 transition-colors ${
                      activeBankIndex === idx ? 'bg-gray-100 ring-2 ring-gray-200' : ''
                    }`}>
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-gray-800 rounded-3xl p-8 text-white shadow-2xl mb-12 transform transition-all duration-1000 delay-700 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
                          ...
                          {tenureIdx === 0 && (
                            ...
                            >
                              <div className="flex items-center space-x-2">
                                <div className={`w-6 h-6 bg-gray-700 rounded-lg flex items-center justify-center shadow-lg`}>
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Bring Your Gold", desc: "Visit our branch with your gold jewelry or ornaments", icon: Coins, color: "from-gray-800 to-gray-700" },
              { step: "02", title: "Gold Assessment", desc: "Our experts evaluate purity and weight using advanced testing", icon: Calculator, color: "from-gray-800 to-gray-700" },
              { step: "03", title: "Loan Approval", desc: "Get instant approval with competitive interest rates", icon: CheckCircle, color: "from-gray-800 to-gray-700" },
              { step: "04", title: "Cash Disbursement", desc: "Receive cash immediately or direct bank transfer", icon: CreditCard, color: "from-gray-800 to-gray-700" }
            ].map((process, idx) => (
              <div key={idx} className="text-center group">
                <div className="relative mb-6">
                  <div className={`w-20 h-20 bg-gray-800 rounded-3xl flex items-center justify-center mx-auto shadow-2xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-300`}>
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-gray-800 rounded-3xl p-8 text-white shadow-2xl text-center transform transition-all duration-1000 delay-900 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
            <h3 className="text-3xl sm:text-4xl font-bold mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-white text-gray-800 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center space-x-2">
                <Phone className="w-5 h-5" />
                <span>Call +91 9788752611</span>
              </button>
              <button className="border-2 border-white text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white hover:text-gray-800 transition-all duration-300 transform hover:scale-105 flex items-center space-x-2">
